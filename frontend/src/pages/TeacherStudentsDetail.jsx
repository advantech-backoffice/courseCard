...
export default function TeacherStudentDetail() {
 ...
 return (
 <div key={course._id} className="rounded-2xl border bg-white overflow-hidden">

 {/* Course Card */}
 <div
 onClick={() => setOpenCourse(isOpen ? null : course._id)}
 className="w-full flex items-center justify-between p-6 cursor-pointer text-left hover:bg-zinc-50 :bg-zinc-800/50 transition-colors"
 >
 <div className="flex items-center">
 <div className="w-12 h-12 bg-emerald-50 rounded-2xl flex items-center justify-center text-emerald-600 mr-4">
 ...
 {/* Modules & Topics */}
 {isOpen && (
 <div className="px-8 pb-6 pt-2 border-t bg-zinc-50 ">
 ...
 {mod.module_content.map((topic, idx) => {
  ...
  const topicStatus = getTopicStatus(course._id, mod.module_name, topicName);
 ...
 <div className="flex flex-col">
  <span className={completed ? "line-through text-zinc-400" : "text-zinc-700 "}>
  {topicName}
  </span>
