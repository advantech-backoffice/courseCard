...
export default function TeacherCourseDetail() {
 ...
 const totalTopics = courseData.modules?.reduce((acc, m) => acc + m.module_content.length, 0) || 1;
  const progressPercent = Math.round((completed / totalTopics) * 1000) / 10;
 ...
 <div key={student._id} className="bg-white rounded-2xl border border-zinc-200 p-6 flex items-center justify-between">
 ...
 {student.isCompleted ? (
 <span className="px-3 py-1 bg-emerald-100 text-emerald-600 text-xs font-bold rounded-full flex items-center">
